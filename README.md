...
1. What does the **runs-on** string
   -> It specifies the type of runner the job will use. In this case, cs5500-self-hosted indicates that the workflow is configured to run on a self-hosted runner with the label cs5500-self-hosted.
